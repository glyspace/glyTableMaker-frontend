...
const ExcelParameters = (props) => {
    ...
    return (
        <Form>
            ...
            <Col xs={2} lg={2}>
            {props.type && props.type === "glycogeniusresult" &&
            
                <Row>
                <Col xs={1}>
                    <Form.Check type="radio" name="group1" id="all" onChange={handleRadioChange}/>
                </Col>
                <Col xs={11}>
                    <FormLabel label="All Samples"/>
                </Col>
                </Row>
            }
            </Col>
